...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Wekoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"wekointools.com", "dnsseed.wekointools.com"},
    {"wekoinpool.org", "dnsseed.wekoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"wekointools.com", "testnet-seed.wekointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Wekoin is probably already running."), addrBind.ToString().c_str());
        else
